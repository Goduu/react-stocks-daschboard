...
import {
    changeHeader, changeHeaderType, changeHeaderName,
    addRow, changeRow
} from '../../../../shared/redux/actions/table.actions.js'
...
const TableSettingMenus = (props) => {
    ...
    const handleChangeType = (event, col) => {
        let field = col.field
        headerControl.find(h => { return h.field === field }).type = event.target.value
        setHeader(headerControl)
    ...
    return (
        <span>
            ...
            >
                ...
                <StyledMenuItem onClick={() => console.log(header)}>
                    see headers
                    </StyledMenuItem>
            </StyledMenu>
